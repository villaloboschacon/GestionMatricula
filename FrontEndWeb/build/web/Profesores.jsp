...
<html>
    ...
    <a ></a>
        ...
        <a class="navbar-brand">Sistema de Matrícula</a>

        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="ingresarEstudiante.jsp">Alumnos <span class="sr-only">(current)</span></a>
                </li>
        ...
        <div class="text-center">
            ...
            <div class="col-6">
                <form style="margin-left:25px" class="form-inline my-2 my-lg-0" action="Profesores" method="POST">
                    ...
                    <button class="btn btn-outline-success my-2 my-sm-0" value="buscar" name="action" type="submit">Search</button>
                </form>
            </div>
        </div>
        <div class="row">  
            <div class="col">
                        ...
                        <tr>
                            ...
                            <td> 
                                <form action="Profesores" method="POST">
                                    ...
                                    <button class="btn btn-info" value="editar" name="action" type="submit" data-toggle="model" data-target="#mEditar">Editar</button>
                                </form>
                            </td>
                ...
                <br>
                <br> 
                <button type="button" class="btn btn-info btn-lg"  data-toggle="modal" data-target="#mIngresar">Ingresar </button>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-primary" value="crear" name="action" type="submit">Ingresar</button>
                        </form>
        ...
        <div id="mEditar" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-primary" value="editar" name="action" type="submit">Editar</button>
                        </form>
                        <button class="btn btn-danger" data-dismiss="modal" type="button" >Cerrar</button>
                    </div>
                    <%
